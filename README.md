...
- `paco2porg`: A shell script that imports paco logs into the porg database.

- `porgball`: A shell script that creates binary tarballs (or `porgballs`) from
...
- `porg_bash_completion`: This file, written by Christian Schneider, provides
bash completion support for porg, in systems that have programmable bash
completion enabled.
...
The creator of porg is David Ricart <icnelis@*> (where * = gmail.com).

The current maintainer of porg is Jeremy Brubaker <jbrubake@orionarts.io>.

I'd like to thank everyone who has contributed to the development of
porg. A complete list of them can be found in the AUTHORS file.

## github Repository

The original Subversion
[repository](https://sourceforge.net/projects/porg/files/) was converted to Git
and posted to Github by Jeremy Brubaker on 17 August 2021. The sourceforge.net
repository had no commits since August 2017.
